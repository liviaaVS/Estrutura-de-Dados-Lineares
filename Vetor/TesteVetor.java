public class TesteVetor {
    ...
    private static void testExceptions(VetorArray vetor) {
        System.out.println("\nTeste de excecoes:");
    ...
    private static void testInsertion(VetorArray vetor) {
    ...
    private static void testReplacement(VetorArray vetor) {
    ...
    private static void testRemoval(VetorArray vetor) {
        System.out.println("\nTeste de remocao:");
        try {
